...
const BLUEPILL_PINS: PinDef[] = [
  ...
  { name: 'PA9', x: 18, y: 78 },
  { name: 'PA10', x: 18, y: 91 },
  { name: 'PA11', x: 18, y: 103 },
  { name: 'PA12', x: 18, y: 116 },
  { name: 'PA15', x: 18, y: 129 },
  { name: 'PB3', x: 18, y: 142 },
  { name: 'PB4', x: 18, y: 154 },
  { name: 'PB5', x: 18, y: 167 },
  { name: 'PB6', x: 18, y: 180 },
  ...
  { name: 'PA1', x: 96, y: 192 },
  { name: 'PA0', x: 96, y: 205 },
  { name: 'PC15', x: 96, y: 218 },
  { name: 'PC14', x: 96, y: 230 },
  { name: 'PC13', x: 96, y: 243 },
  { name: 'VBAT', x: 96, y: 256 },
];
...
const BLACKPILL_PINS: PinDef[] = [
  ...
  { name: 'PB4', x: 89, y: 116 },
  { name: 'PB3', x: 89, y: 129 },
  { name: 'PA15', x: 89, y: 142 },
  { name: 'PA12', x: 89, y: 154 },
  { name: 'PA11', x: 89, y: 167 },
  { name: 'PA10', x: 89, y: 180 },
  { name: 'PA9', x: 89, y: 192 },
  { name: 'PA8', x: 89, y: 205 },
  { name: 'PB15', x: 89, y: 218 },
  { name: 'PB14', x: 89, y: 230 },
  { name: 'PB13', x: 89, y: 243 },
  { name: 'PB12', x: 89, y: 256 },
];
...
const CONFIGS: Record<string, BoardConfig> = {
  'stm32-bluepill': {
    render: 'svg',
    svgUrl: '/boards/stm32-bluepill.svg',
    w: 114,
    h: 271,
    pins: BLUEPILL_PINS,
    led: { x: 37, y: 228 },
  ...
  'stm32-blackpill': {
    render: 'svg',
    svgUrl: '/boards/stm32-blackpill.svg',
    w: 103,
    h: 266,
    pins: BLACKPILL_PINS,
    led: { x: 27, y: 55 },
  ...
  'stm32-olimex-h405': inlineConfig({
    ...
    left: ['3V3', 'GND', 'PA0', 'PA1', 'PA2', 'PA3', 'PB6', 'PB7', 'PB8', 'PB9', 'PC0', 'PC1'],
    right: ['5V', 'GND', 'PC12', 'PC10', 'PC11', 'PA4', 'PA5', 'PA6', 'PA7', 'PB0', 'PB1', 'PB10'],
    ledPin: 'PC12',
    ledActiveLow: false,
  }),
  'stm32-netduino-plus2': inlineConfig({
    label: 'Netduino Plus 2',
    left: ['3V3', 'GND', 'PA0', 'PA1', 'PA2', 'PA3', 'PA4', 'PA5', 'PB6', 'PB7', 'PB8', 'PB9'],
    right: ['5V', 'GND', 'PA10', 'PB11', 'PC0', 'PC1', 'PC2', 'PC3', 'PA6', 'PA7', 'PB0', 'PB1'],
    ledPin: 'PA10',
    ledActiveLow: false,
  }),
