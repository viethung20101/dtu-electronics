...
`,
  ...
  wires: [
    {
      id: 'w-cs',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP9' },
      end: { componentId: 'epd-213', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP8' },
      end: { componentId: 'epd-213', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP12' },
      end: { componentId: 'epd-213', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP13' },
      end: { componentId: 'epd-213', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP19' },
      end: { componentId: 'epd-213', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP18' },
      end: { componentId: 'epd-213', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'raspberry-pi-pico', pinName: '3V3' },
      end: { componentId: 'epd-213', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GND.1' },
      end: { componentId: 'epd-213', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
  ...
  wires: [
    {
      ...
      end: { componentId: 'epd-290', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'esp32', pinName: '17' },
      end: { componentId: 'epd-290', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'esp32', pinName: '16' },
      end: { componentId: 'epd-290', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'esp32', pinName: '4' },
      end: { componentId: 'epd-290', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'esp32', pinName: '23' },
      end: { componentId: 'epd-290', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'esp32', pinName: '18' },
      end: { componentId: 'epd-290', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'esp32', pinName: '3V3' },
      end: { componentId: 'epd-290', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'esp32', pinName: 'GND.1' },
      end: { componentId: 'epd-290', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
  ...
  wires: [
    {
      id: 'w-cs',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP9' },
      end: { componentId: 'epd-420', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP8' },
      end: { componentId: 'epd-420', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP12' },
      end: { componentId: 'epd-420', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP13' },
      end: { componentId: 'epd-420', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP19' },
      end: { componentId: 'epd-420', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GP18' },
      end: { componentId: 'epd-420', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'raspberry-pi-pico', pinName: '3V3' },
      end: { componentId: 'epd-420', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'raspberry-pi-pico', pinName: 'GND.1' },
      end: { componentId: 'epd-420', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
  ...
  wires: [
    {
      id: 'w-cs',
      start: { componentId: 'esp32', pinName: '5' },
      end: { componentId: 'epd-750', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'esp32', pinName: '17' },
      end: { componentId: 'epd-750', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'esp32', pinName: '16' },
      end: { componentId: 'epd-750', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'esp32', pinName: '4' },
      end: { componentId: 'epd-750', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'esp32', pinName: '23' },
      end: { componentId: 'epd-750', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'esp32', pinName: '18' },
      end: { componentId: 'epd-750', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'esp32', pinName: '3V3' },
      end: { componentId: 'epd-750', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'esp32', pinName: 'GND.1' },
      end: { componentId: 'epd-750', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
  ...
  wires: [
    {
      id: 'w-cs',
      start: { componentId: 'esp32', pinName: '5' },
      end: { componentId: 'epd-290-bwr', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'esp32', pinName: '17' },
      end: { componentId: 'epd-290-bwr', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'esp32', pinName: '16' },
      end: { componentId: 'epd-290-bwr', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'esp32', pinName: '4' },
      end: { componentId: 'epd-290-bwr', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'esp32', pinName: '23' },
      end: { componentId: 'epd-290-bwr', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'esp32', pinName: '18' },
      end: { componentId: 'epd-290-bwr', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'esp32', pinName: '3V3' },
      end: { componentId: 'epd-290-bwr', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'esp32', pinName: 'GND.1' },
      end: { componentId: 'epd-290-bwr', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
  ...
  wires: [
    {
      id: 'w-cs',
      start: { componentId: 'esp32', pinName: '5' },
      end: { componentId: 'epd-565', pinName: 'CS' },
      color: '#ffaa00',
    },
    {
      id: 'w-dc',
      start: { componentId: 'esp32', pinName: '17' },
      end: { componentId: 'epd-565', pinName: 'DC' },
      color: '#aa66ff',
    },
    {
      id: 'w-rst',
      start: { componentId: 'esp32', pinName: '16' },
      end: { componentId: 'epd-565', pinName: 'RST' },
      color: '#ff4444',
    },
    {
      id: 'w-busy',
      start: { componentId: 'esp32', pinName: '4' },
      end: { componentId: 'epd-565', pinName: 'BUSY' },
      color: '#22cc22',
    },
    {
      id: 'w-mosi',
      start: { componentId: 'esp32', pinName: '23' },
      end: { componentId: 'epd-565', pinName: 'SDI' },
      color: '#22aaff',
    },
    {
      id: 'w-sck',
      start: { componentId: 'esp32', pinName: '18' },
      end: { componentId: 'epd-565', pinName: 'SCK' },
      color: '#ffdd33',
    },
    {
      id: 'w-vcc',
      start: { componentId: 'esp32', pinName: '3V3' },
      end: { componentId: 'epd-565', pinName: 'VCC' },
      color: '#ff4444',
    },
    {
      id: 'w-gnd',
      start: { componentId: 'esp32', pinName: 'GND.1' },
      end: { componentId: 'epd-565', pinName: 'GND' },
      color: '#000000',
    },
  ],
};
